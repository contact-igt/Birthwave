    ...
    <section id="top" className="relative overflow-hidden bg-cream pt-14 pb-20 md:pt-20 md:pb-28">
      <Container className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
        <div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <a
              ...
              className="rounded-full border border-primary-300 px-7 py-3.5 text-sm font-semibold text-ink transition-colors hover:border-primary-500 hover:text-primary-600"
            >
              Message on WhatsApp
            </a>
          </div>
        ...
        <div className="relative mx-auto aspect-square w-full max-w-sm">
          <div
            className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-blue-500/35 via-primary-300/40 to-primary-500/50"
            aria-hidden="true"
          />
