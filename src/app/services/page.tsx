...
export const metadata: Metadata = {
  ...
  description:
    "Every service at The Birthwave, from pregnancy and antenatal care through VBAC, fertility, vaginismus support and newborn care — doctor-led, in Nungambakkam, Chennai.",
};
